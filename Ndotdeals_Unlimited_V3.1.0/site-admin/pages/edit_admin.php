...
if($_POST)
{
	...
	if($url_arr[3]=='AD'){
		...
		$queryString = "update coupons_users set firstname = '$firstname' ,lastname = '$lastname', email = '$email', mobile = '$mobile', address = '$address', country = '$country', city ='$city' where userid= '$user_id'";
	}
