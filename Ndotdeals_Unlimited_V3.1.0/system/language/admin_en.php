...
"storeadminregistration" => "Merchant Registration",
"citymanagerregistration" => "Reseller Registration",
"addshop" => "Add Shop",
...
"allusers" => "All Users",
"manageshopadmin" => "Manage Merchant",
"managecitymanager" => "Manage Reseller",
...
"search_bydealname" => "Search by Deal Name",
"search_bytrans" => "Search by Deal Description, User Name, Transaction Id",
"search_bymerchantusr" => "Search by User Name, Shop Details, Email Id",
"search_byctyusr" => "Search by User Name, Email Id",
"search_bydisname" => "Search by Deal Name, User Name, Comment",
...
// Unlimited V3.5 language variable 
"categoryimage" =>"Category Image",
"image_required" => "Choose the category image",
"smtpport" => "Smtp Port",
"enteryoursmtpport" => "Enter your Smtp Port",
...
"deal_not_post" => "Feature deal not post",
"images_size_should_be" => "Images size should be",
"amount_from_payout" => "Amount from payout's so far",
"total_coupons_sold" => "Total coupons sold",
"coupons_sold_today"=>"coupons sold today",
"total_savings_today" => "Total savings today",
"sales" => "Sales Count",
"shop_sales" => "Shops Sales",
"transaction_status" => "Transactions Status",
"offline_payment" => "Offline Payment",
"referral_amount_used" => "Referral Amount Used",
"Coupon_Name" => "Coupon Name",
"Transaction_status_has_been_updated" => "Transaction status has been updated Successfully",
