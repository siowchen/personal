		...
		$out = '
					<table class="adminlist">
						...
						<tr>
							...
							<td><input type="text" name="company" value="NDot" /></td>
						</tr>
						<tr>
							<td width="50%">'.'Website URL'.'</td>
							<td><input type="text" name="site" value="http://www.ndot.in" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="text" name="email" value="mderbi@ndot.in" /></td>
						</tr>
						<tr>
