<?php
$api_key = end(explode('=',$_SERVER['REQUEST_URI']));

if($api_key == SITE_LICENSE_KEY)
{
	...
	//set_response_mes(1, 'Mail has been sent Successfully.'); 	
	//url_redirect($redirect_url);
	
	}
	else
	{
		set_response_mes(1, "Your License Key is not Valid");
