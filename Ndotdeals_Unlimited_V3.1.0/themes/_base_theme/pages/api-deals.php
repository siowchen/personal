...
<ul class="fl clr terms">
<li class="fl clr">GET /api/city/</li>
<li>Show a list of all launched cities.</li>        
<li>GET api/deal/<id></li>
<li>Shows a random deal for a city</li>
<li>GET /api</li>
<li>Show a list of all deals for a city</li>
</ul>
<h2 class="fl clr mt10">GET /city/</h2>

<p>Show a list of all launched cities.</p>

<h2 class="fl clr mt10">URL</h2>

<code class="api_code clr fl" ><?php echo $docroot;?>api/city/</code>

<h2 class="fl clr mt10">Formats</h2>

<p class="fl clr mt5">JSON (default)</p>
<p>XML</p>

<h2 class="fl clr mt10">Authentication Required</h2>
<p>No</p>

<h2 class="fl clr mt10">URL Parameters</h2>
<ul class="terms">
...
<h2 class="fl clr mt10">Sample JSON Request</h2>
<code class="api_code clr fl mt5">GET <?php echo $docroot;?>api/city/?client_id=abcd1234567890</code>
<p>OR</p>
<code class="api_code clr fl">GET <?php echo $docroot;?>api/city/?client_id=abcd1234567890&format=json</code>

<h2 class="fl clr mt10">Sample JSON Response</h2>  
<code class="api_code mt5">	
...
<h2 class="fl clr mt10">Sample XML Request</h2>
<code class="api_code clr mt5 fl">GET <?php echo $docroot;?>api/city/?client_id=abcd1234567890&format=xml</code>

<h2 class="fl clr mt10">Sample XML Response</h2>
<code class="clr fl api_code mt5">
&lt;?xml version="1.0"?&gt;<br/>
&lt;response&gt;<br/>
        &lt;cities&gt;<br/>
               &lt;city&gt;<br/>
...
<h2 class="fl clr mt10">GET /deal/</h2>

<p>Shows detailed information about a specified deal</p>

<h2 class="fl clr mt10">URL</h2>

<code class="api_code clr fl mt5"><?php echo $docroot;?>api/deal/</code>
...
<h2>Sample JSON Response</h2>
<code class="api_code fl clr" style="width:600px;">
