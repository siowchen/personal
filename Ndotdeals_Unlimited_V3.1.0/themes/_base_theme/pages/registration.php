...
<div class="work_bottom1">
       ...
       <?php  /* <form name="registration" id="registration"  action="<?php echo $action_url; ?>"  method="post"  >   */  ?>
		...
		<td>
		<?php  /* <input type="text" class="input_box required nospecialchars" name="username" title="<?php echo $language['valid_username']; ?>" id="usernameval" onblur="checkusername(this.value)" maxlength="50" value=""  />
		 <span id="unameavilable" class="validerror" style="color:red"> </span> */  ?>
		   ...
		   <input type="text" class="required" title="<?php echo $language['enterusernameinalphanumeric']; ?>" name="username" id="usernameval" value="" onblur="checkusername(this.value)" maxlength="50" /><br>
	          <span id="unameavilable" class="validerror" style="color:red;float:left!important;clear:both!important;"> </span>
		...
		<td>
		<?php  /* <input type="text" class="input_box required email" name="email" id="email" title="<?php echo $language['valid_email']; ?>" /> */  ?>
		...
		<input type="text" class="email required" title="<?php echo $language['enteremailaddress']; ?>" id="email" name="email" value="" onblur="checkeamil(this.value)" maxlength="100" /><br>
	        <span id="emailavilable" class="validerror" style="color:red;float:left!important;clear:both!important;"> </span>
		...
		<td>
        	<div class="signup_now">
                <span class="submit"><input type="submit" name="signup" value="<?php echo $language['signup']; ?>" class="bnone"/></span>
	       <span class="reset "><input type="reset" class="bnone" value="<?php echo $language['reset']; ?>" /></span>
          	</div>      
		</td>
		</tr>
		</table>
