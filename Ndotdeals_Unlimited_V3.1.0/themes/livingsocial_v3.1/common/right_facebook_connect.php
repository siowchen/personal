...
<div class="content_right1  fl clr">
  <div class="great_deals">
    ...
    <div class="great_center">
      <div class="contact_right fl clr">
        <p> <?php echo $language["already_have_account"]; ?><br />
          <?php echo $language["use_it"]; ?> </p>
        <a href="javascript:;" onclick="return fbconnect('<?php echo DOCROOT; ?>');" title="facebook connect" class="bg_facebook fl clr mt15 ml10"></a> </div>
    </div>
