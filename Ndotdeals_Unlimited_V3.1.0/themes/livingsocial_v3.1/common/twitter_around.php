<div class="great_deals mb15 fl clr">
  <div class="great_top">
    <h1><?php echo $language['twitter_connect']; ?></h1>
  </div>
  <div class="great_center">
    <div class="width220 fl clr">
      <?php
            ...
            function twitter_date_diff($d1, $d2)
            {
                ...
                else
                {
                 ...
                 //     }
                    ...
                    if(isset($_SESSION['defaultcityId']))
                    {
                      ...
                      ?>
		      <span title="Visit more cities" class="city_link">
		      <?php 
                            $result = get_cityname();
                   ...
                   $search = "http://search.twitter.com/search.atom?q='".$city."'";
                    ...
                    $year = date('y', $date);
                    $message = $row['content']; //echo $theDate."LLLLLLLLLLL".$date; exit; 
                    $datediff = twitter_date_diff($theDate, $date);
