  ...
  <div class="contact_left">
    <form action="" name="contactus" id="contactus" method="post">
      <table width="100%" border="0" cellpadding="5" cellspacing="5" class="contact_user">
        ...
        <tr height="60">
          <td>&nbsp;</td>
          <td valign="top" class="terms_error"><input type="checkbox" value="1" name="agreeopt" title="<?php echo $language['in_order_to_use_terms_of_service']; ?>" class="fl required" style="margin:0px;" />
            <h3 style="width:250px;float:left;margin-left:5px;*margin-top:3px;"><span  style="float:left;font:normal 12px arial;color:#000;"><?php echo $language['agree']; ?> </span>
