  ...
  <div class="content_right1 mb-10">
	  <div class="great_deals">
		...
		<div class="contact_right fl clr">
			...
			<a href="<?php echo DOCROOT;?>system/modules/twitter/index.php" title="twitter connect" class="bg_twitter fl clr mt15 ml10"></a>
		</div>			
		</div>   
		<div class="great_bottom pb10"></div>
	 </div>
  </div>
